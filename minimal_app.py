#!/usr/bin/env python3
"""
Minimal Blockchain Fraud Detection Dashboard
Ultra-simple version for fast Streamlit Cloud deployment
"""
...
def main():
    ...
    st.markdown("**Status**: ✅ Deployed on Streamlit Cloud")
    ...
    if st.session_state.transactions:
        for tx in st.session_state.transactions[-5:]:  # Show last 5
            with st.container():
                ...
                with col3:
                    st.write(f"{tx['location']} - {tx['timestamp']}")
                with col4:
