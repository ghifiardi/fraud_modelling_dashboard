...
echo "   ------------------------------------"
echo "   OPENAI_API_KEY = \"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\""
echo ""
echo "7. 🚀 Click 'Deploy!'"
echo ""
echo "📚 Documentation:"
